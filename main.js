let formIntro = document.querySelector('.intro');
let selectIntro = document.querySelector('#game_values');
let submitBtn = document.querySelector('#submit');
let intorBlock = document.querySelector('.intro_wrapper')
let gameBlock = document.querySelector('.game_wrapper');
...
// gameTimeSelector.addEventListener('change', function () {
    
// }

submitBtn.addEventListener('click', function () {
    intorBlock.classList.add('block_hidden');
